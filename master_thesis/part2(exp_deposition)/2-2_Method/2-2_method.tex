...
枝の太さの結果\ref{fig:branch}\subref{fig:branch_thickness}より，枝の太さは太くても，おおむね$\SI{10}{px}\approx\SI{1.6}{mm}$であることがわかる。そのため，枝の長さが$\SI{1.6}{mm}$に満たないものはノイズ（例えるならば，幹に生えたコブ）によるものとして除外した。
