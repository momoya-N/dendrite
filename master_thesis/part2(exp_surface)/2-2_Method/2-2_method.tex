...
また，極板を四角形のような角のある形状にすると，十分に界面成長する前に角の部分で樹枝状結晶が発生してしまった。これは極板の角で電場が強くなりイオンが集中したためと思われる。そのため，図\ref{fig:surface_exp_system}\subref{fig:sys_top_surface}の様に円形極板にすることで，角からの急速な樹枝状結晶の成長を抑制し，また，陽極の横幅を狭めることで，界面の成長範囲を制御した。
\subsection{解析方法}
\begin{figure}[htbp]
  \begin{minipage}
    {0.64\textwidth}
